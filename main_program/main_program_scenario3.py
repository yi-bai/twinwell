...
This module is used to check the performance of cars (autonomous vehicles which provide MaaS).
At the same time, buses always choose a low-priority lane.


This is named as Scenario3
'''
...
outfile=open(r"D:\03Work during PD\31ERP2_in_COI\meso_by_python\output_S3.csv","ab")#%%%%%%%%%%%%%%%%%%%%%for checking the results
...
outfile_lane_features=open(r'D:\03Work during PD\31ERP2_in_COI\meso_by_python\outfile_lane_features_S3.csv',"ab")
writer_lane_features=csv.writer(outfile_lane_features)

outfile_veh_features=open(r'D:\03Work during PD\31ERP2_in_COI\meso_by_python\outfile_veh_features_S3.csv',"ab")
