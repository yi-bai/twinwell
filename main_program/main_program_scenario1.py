...
revised on 2018/8/15
This module is used to check the performance of buses who have the absolute priority of using faster lanes.
At the same time, cars randomly selecting the faster lanes.

This is named as Scenario1
'''
...
outfile=open(r"D:\03Work during PD\31ERP2_in_COI\meso_by_python\output_S1.csv","ab")#%%%%%%%%%%%%%%%%%%%%%for checking the results
...
outfile_lane_features=open(r'D:\03Work during PD\31ERP2_in_COI\meso_by_python\outfile_lane_features_S1.csv',"ab")
writer_lane_features=csv.writer(outfile_lane_features)

outfile_veh_features=open(r'D:\03Work during PD\31ERP2_in_COI\meso_by_python\outfile_veh_features_S1.csv',"ab")
