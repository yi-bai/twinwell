...
def ReadNodes(nodefile,dic_nodes):
...
def ReadLanes(lanefile,dic_graph_high,dic_graph_low,dic_lanes):
...
def ReadLanes2(lanefile,dic_graph,dic_lanes):
    #similar to ReadLane, just one dic_graph
...
def LengthCal2(dic_lanes,dic_nodes):
    # this function calculate and update the length of lanes inside a graph with the node id coordinates 
